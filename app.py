...
def create_guepardo():
    ...
    nuevo_guepardo = Guepardo(
        nombre=nombre, edad=edad, velocidad_maxima=velocidad_maxima, habitat=habitat
    )
    ...
    return (
        jsonify(
            {
                "message": "Guepardo creado exitosamente",
                "guepardo": {
                    "id": nuevo_guepardo.id,
                    "nombre": nuevo_guepardo.nombre,
                    "edad": nuevo_guepardo.edad,
                    "velocidad_maxima": nuevo_guepardo.velocidad_maxima,
                    "habitat": nuevo_guepardo.habitat,
                },
            }
        ),
        201,
...
def get_guepardos():
    ...
    result = [
        {
            "id": guepardo.id,
            "nombre": guepardo.nombre,
            "edad": guepardo.edad,
            "velocidad_maxima": guepardo.velocidad_maxima,
            "habitat": guepardo.habitat,
        }
...
def update_guepardo(id):
    ...
    return (
        jsonify(
            {
                "message": "Guepardo actualizado exitosamente",
                "guepardo": {
                    "id": guepardo.id,
                    "nombre": guepardo.nombre,
                    "edad": guepardo.edad,
